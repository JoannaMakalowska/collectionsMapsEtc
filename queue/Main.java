...
public class Main {
    ...
    final static private String slowoSzukane = new String("Saloperie");
}
    ...
    public void szukajSlowa (File przeszukiwanyPlik) throws FileNotFoundException
    {
        ...
        while (reader.hasNextLine())
        {
            ...
            if (reader.nextLine().contains(szukaneSlowo))
                System.out.println("Szukane slowo znajduje sie w pliku: "+przeszukiwanyPlik.getPath()+" w linii "+numerLinii);
        }
